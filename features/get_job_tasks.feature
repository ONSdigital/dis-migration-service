  ...
  Rule: User that is authorised and authenticated
    ...
    Scenario: Get a list of tasks filtered by a single state
      ...
      And the following document exists in the "tasks" collection:
        ...
        """
      When I GET "/v1/migration-jobs/2874ee9e-1cec-44f8-9b6d-998cf2062791/tasks?state=migrating"
      Then I should receive the following JSON response with status "200":
        """
        {
          "count": 1,
    ...
    Scenario: Get a list of tasks filtered by multiple states using repeated query param
      ...
      And the following document exists in the "tasks" collection:
        ...
        """
      When I GET "/v1/migration-jobs/2874ee9e-1cec-44f8-9b6d-998cf2062791/tasks?state=migrating&state=publishing"
      Then I should receive the following JSON response with status "200":
        """
        {
          "count": 2,
    ...
    Scenario: Get a list of lists with an invalid state
      Given the following document exists in the "jobs" collection:
        ...
        """
      When I GET "/v1/migration-jobs/2874ee9e-1cec-44f8-9b6d-998cf2062791/tasks?state=unknown"
