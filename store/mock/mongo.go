...
func (mock *MongoDBMock) GetJobNumberCounter(ctx context.Context) (*domain.Counter, error) {
	if mock.GetJobNumberCounterFunc == nil {
		panic("MongoDBMock.GetJobNumberCounterFunc: method is nil but MongoDB.GetJobNumberCounter was just called")
	}
	callInfo := struct {
		Ctx context.Context
	}{
...
// Check the length with:
//     len(mockedMongoDB.GetJobNumberCounterCalls())
func (mock *MongoDBMock) GetJobNumberCounterCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
