...
.PHONY: build
build: ## Builds binary of application code and stores in bin directory as dis-migration-service
	go build -tags 'production' $(LDFLAGS) -o $(BINPATH)/dis-migration-service
